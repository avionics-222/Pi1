# MAX31865 with PT100 on Raspberry Pi 4 (Two-Wire Configuration)
...
def calculate_temperature(resistance):
    ...
    temperature = ((rtd_ratio - 1) / 0.00385 )   #Calibration Factor //3.3 //3.0
    return temperature
...
try:
    ...
    while True:
        ...
        print(f"Temperature: {temp:.2f} *C | Resistance: {res:.2f} O")
        print("----------------------------------------")
        time.sleep(0.5)
