...
if __name__ == "__main__":
   ...
   # main(23,24,270,-979799.5,do_calib)
    ...
    # Setup CSV file
    os.makedirs("logs_thrust", exist_ok=True)
    csv_filename = f"logs_thrust/{datetime.now().strftime('%Y%m%d_%H%M%S')}.csv"
    ...
    try:
        ...
        while True:
            ...
            total_weight = sum(latest_weights[0:4]) - 2.0     #-2.05      #Propeller + Bolt Weight ~= 2Kg (two blade) ~= 4.05 Kg (three blade)
