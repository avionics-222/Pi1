...
RPM_COMMAND_REGISTER = 0x31
RPM_REGISTER = 0xA8              #0x30
VOLTAGE_REGISTER = 0xEB
TORQUE_REGISTER = 0xA0
KT_REGISTER = 0x87
CURRENT_REGISTER = 0x20 # I actual (Motor Current)
TEMP_REGISTER = 0x49
VDC_REGISTER = 0xEB # Bus Voltage
VOUT_VXXX = 0x8A # Motor Voltage
IGBT_TEMP = 0x4A 
BATTERY_ID = 0x0222 #Battery CAN ID
"""
# ESC Parameter Registers
RPM_REGISTER = 0xA8
VOLTAGE_REGISTER = 0xEB
