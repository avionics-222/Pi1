...
if __name__ == "__main__":
   ...
   # main(23,24,270,-979799.5,do_calib)
    ...
    hardcoded_offsets = [-275053.5, 789272.0, 1333021.5, -2035802.5, 0, 0, 0, 0]
    load_cell_labels = [
    ...
    try:
        ...
        while True:
            ...
            total_weight = sum(latest_weights[0:4]) -7.40     #+ 2.1 - 2.0 - 0.49 - 3.2      #-2.05      #Propeller + Bolt Weight ~= 2Kg (two blade) ~= 4.05 Kg (three blade)
            
            if load_cell_state == 1:
                print(f"Latest Weights: {latest_weights} | Total: {total_weight:.2f} Kg | TorqueForce: {total_weight * 9.8: .3f} N")
            if esc_data_state == 1:
