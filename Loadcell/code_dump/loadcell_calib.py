...
class HX711:
    def __init__(self, dout_pin=20, sck_pin=21):
        ...
        self.calibration_factor = 25.4              #//120kg: 25.4     #//10kg: 145  //50kg: 40.04
        self.offset = 0
    ...
    def read_average(self, num_readings=3):
...
def main():
    ...
    hx = None
    try:
        hx = HX711(dout_pin=20, sck_pin=21)
