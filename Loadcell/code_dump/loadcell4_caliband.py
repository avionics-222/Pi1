...
if __name__ == "__main__":
    ...
    #weight1 = main(5,6,0,-1560757.0,do_calib)
    #weight2 = main(12,13,90,1897135.5,do_calib)
    #weight3 = main(17,27,180,323036.5,do_calib)
    #weight4 = main(22,23,270,378924.5,do_calib)
    
    #print("Weight = ", weight1+weight2+weight3+weight4  :.2f," Kg")
