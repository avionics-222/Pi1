    ...
    try:
        ...
        while True:
            if myKx.data_ready():
                ...
                time.sleep(0.001)  # Delay = 1 / ODR = 1/200Hz = 0.005s
            else:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--accel_location', type=str, default='ACC', help='Accelerometer location')
    ...
    try:
        ...
        while True:
            ...
            # Display current readings of loadcell,Accelerometer & ESC
            if accel_state == 1:
